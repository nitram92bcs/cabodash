...
<header id="mu-hero">
<div class="container">
  <nav class="navbar navbar-expand-lg navbar-light mu-navbar sticky-top fixed-top">
    <!-- Text based logo -->
    <!-- <a class="navbar-brand mu-logo" href="index.html"><span>B-HERO</span></a> -->
    <!-- image based logo -->
      <a class="navbar-brand mu-logo" href="/"><img src="/img/logo-dash.png" alt="Cabo Dash"></a>
